...
async def retranslator_handler(event):
    ...
    if any(word in text_lc for word in ["харків", "область", "чугуїв", "куп'янськ", "богодухів", "дергачі", "бпла", "Балістика", "Є загроза для", "купянск", "шахед", "шаболда", "Развед.БПЛА", "КАБ на", "Швидкісна на", "Активність тактичної авіації на сході", "шаболда"]):
        try:
